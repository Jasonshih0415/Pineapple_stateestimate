...
def dump_pickle(filename: str, data: dict | object):
    """Dump a configuration object as a pickle file.

    Isaac Lab 2.x removed ``isaaclab.utils.io.dump_pickle``. Keep the
    training log artifact format expected by this script with a local helper.
    """

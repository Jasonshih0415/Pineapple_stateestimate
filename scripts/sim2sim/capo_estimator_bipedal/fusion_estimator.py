...
Typical use::
    ...
    from capo_estimator_bipedal import FusionEstimatorCore, LowlevelState
...
from .lowlevel_state import MOTOR_NUM, LowlevelState, Odometer
...
class FusionEstimatorCore:
    ...
    def fusion_estimator_status(self, status):
        ...
        if mode == 1:
            ...
            for i in range(self.legs_pos.ContactChainNum):
    ...
    def fusion_estimator(self, st):
        ...
        if self.legs_pos.JointsXYZEnable or self.legs_pos.JointsXYZVelocityEnable:
            # Preserve CAPO's 16-slot layout: q starts at 0, dq at 16 and
            # torque at 32. Pineapple fills motor slots 0..7 only.
            joint = [0.0] * 48
        ...
        # Legacy Odometer keeps four contact fields; Pineapple has only two.
        odom.RLFootLanded, odom.RRFootLanded = 0.0, 0.0

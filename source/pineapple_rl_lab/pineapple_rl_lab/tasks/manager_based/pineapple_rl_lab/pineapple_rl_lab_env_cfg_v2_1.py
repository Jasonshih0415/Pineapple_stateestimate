...
from pineapple_rl_lab.tasks.manager_based.pineapple_rl_lab.mdp.terrains import CUSTOM_FLAT_TERRAINS_CFG
...
class PineappleCommandsCfg:
    ...
    base_height = pineapple_mdp.PineappleHeightCommandCfg(
        asset_name="robot",
        resampling_time_range=(10.0, 15.0),
        ranges=pineapple_mdp.PineappleHeightCommandCfg.Ranges(height=(0.25, 0.35)),
        default_height=0.3,
        rel_default_height_envs=0.3,
    )
...
class PineappleFlatEnvCfgV2(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        #     terrain_generator=CUSTOM_FLAT_TERRAINS_CFG,
        ...
        # self.scene.height_scanner.prim_path = "{ENV_REGEX_NS}/Robot/" + BASE_LINK_NAME

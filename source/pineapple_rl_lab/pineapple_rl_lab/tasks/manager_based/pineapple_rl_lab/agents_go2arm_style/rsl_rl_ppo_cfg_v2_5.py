...
class Go2ArmRslRlPpoAlgorithmCfg(RslRlPpoAlgorithmCfg):
    ...
    min_policy_std: list = MISSING
    """The minimum policy standard deviation for each action."""
...
class Go2ArmFlatPPORunnerCfg(Go2ArmRslRlOnPolicyRunnerCfg):
    ...
    algorithm = Go2ArmRslRlPpoAlgorithmCfg(
        ...
        min_policy_std=[[0.15] * 6 + [0.15] * 2 + [0.2] * 6],
        eps = 1e-5,
    )
...
class Go2ArmRoughPPORunnerCfg(Go2ArmRslRlOnPolicyRunnerCfg):
    ...
    algorithm = Go2ArmRslRlPpoAlgorithmCfg(
        ...
        min_policy_std=[[0.15] * 6 + [0.25] * 2 + [0.2] * 6],
        eps = 1e-5,
    )


@configclass
class PineappleArmV25PPORunnerCfg(Go2ArmFlatPPORunnerCfg):
    experiment_name = "pineapple_arm_flat_v2_5"
    max_iterations = 15000
    save_interval = 1000

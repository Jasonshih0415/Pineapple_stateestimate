...
PINEAPPLE_V2_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=True,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ISAACLAB_ASSETS_DATA_DIR}/Robots/csl/pineapple_v2/urdf/pineapple_v2.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            "L_hip_joint": 0.0,
            "L_thigh_joint": 0.879, # 0.879 1.3355
            "L_calf_joint": -1.469, # -1.469 -2.116
            "L_wheel_joint": 0.0,
            "R_hip_joint": 0.0,
            "R_thigh_joint": 0.879, # 0.879 1.3355
            "R_calf_joint": -1.469, # -1.469 -2.116
            "R_wheel_joint": 0.0,
        },
        joint_vel={".*": 0.0},
    ),
